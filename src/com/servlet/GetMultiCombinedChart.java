...
public class GetMultiCombinedChart extends HttpServlet {
		...
		String arrrightspk[] = request.getParameter("rights").split("\\|");					  	
	  	String haxisname=request.getParameter("haxis");   
   		...
   		Create_Echarts ce = new Create_Echarts();
   	  	String result = ce.createmulticombinedcharts(sql,dbname,haxisname,vaxisname,vcharttype,showvalue,secondaxisvalue,username,arrrightspk[0],arrrightspk[1]);    
