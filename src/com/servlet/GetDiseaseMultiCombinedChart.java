...
public class GetDiseaseMultiCombinedChart extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		String arrrightspk[] = request.getParameter("rights").split("\\|");		  	
	  	String haxisname=request.getParameter("haxis");   
	   	...
	   	String secondaxisvalue = request.getParameter("secondaxisvalue"); 
   		Create_Echarts ce = new Create_Echarts();
   	  	String result = ce.createmulticombinedcharts_for_disease(sql,dbname,haxisname,vaxisname,vcharttype,showvalue,secondaxisvalue,username,arrrightspk[0],arrrightspk[1]);       
