...
public class GetMultiBarChart extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		String arrrightspk[] = request.getParameter("rights").split("\\|");				  	
	  	...
	  	String result = ce.createmultibarcharts(sql,dbname,haxisname,vaxisname,username,arrrightspk[0],arrrightspk[1]);
