...
public class GetCensusComboxSelections extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		if(word_id.equals("province")){
			sql = "select distinct province from AdminCode_SixCensus order by province";
			variable = "province";
			...
			sql = "select distinct city from AdminCode_SixCensus where " + sql_str;
			variable = "city";
			tempResponse=node.getComboResult(sql,variable); 		
		}
			...
			sql = "select distinct district from AdminCode_SixCensus where " + sql_str_province + " and " + sql_str_city;
			variable = "district";			
			tempResponse=node.getComboResult(sql,variable); 	
		}
