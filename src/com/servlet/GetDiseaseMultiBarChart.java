...
public class GetDiseaseMultiBarChart extends HttpServlet {
		...
		String arrrightspk[] = request.getParameter("rights").split("\\|");		  	
	  	String haxisname=request.getParameter("haxis");   
   		...
   		Create_Echarts ce = new Create_Echarts();
   	  	String result = ce.createmultibarcharts_for_disease(sql,dbname,haxisname,vaxisname,username,arrrightspk[0],arrrightspk[1]);
