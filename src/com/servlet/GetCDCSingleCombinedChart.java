...
public class GetCDCSingleCombinedChart extends HttpServlet {
		...
		response.setCharacterEncoding("UTF-8");	
	  	...
	  	String haxisname=request.getParameter("haxis");   
   		...
   		Create_Echarts ce = new Create_Echarts();
   	  	String result = ce.createsinglecombinedcharts_for_cdc(sql,dbname,haxisname,vaxisname,vcharttype,showvalue); 
