...
public class GetDiseaseSingleCombinedChart extends HttpServlet {
		...
		String arrrightspk[] = request.getParameter("rights").split("\\|");	  	
	  	String haxisname=request.getParameter("haxis");   
   		...
   		Create_Echarts ce = new Create_Echarts();
   	  	String result = ce.createsinglecombinedcharts_for_disease(sql,dbname,haxisname,vaxisname,vcharttype,showvalue,username,arrrightspk[0],arrrightspk[1]);    
