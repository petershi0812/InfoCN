...
public class GetDiseaseBubbleChart extends HttpServlet {
		...
		String arrrightspk[] = request.getParameter("rights").split("\\|");		  	
	  	...
	  	String haxisname=request.getParameter("haxis");
   		...
   		Create_Echarts ce = new Create_Echarts();
   	  	String result = ce.createbubblecharts_for_disease(sql,dbname,label,haxisname,vaxisname,zaxisname,username,arrrightspk[0],arrrightspk[1]);  
