...
public class GetAllDiseaseGridstorePage extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		String result = AGP.AllGridstorePage_for_Disease(sql,dbname,numcolumnpoint,start,limit,username,arrrightspk[0],arrrightspk[1]);
