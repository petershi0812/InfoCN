...
function fun_grid_colModel_config(_type,_grid_sm){
	if(_type == 'top10_Industry_dataset'){
		var grid_colModel_array =			
			[					
				_grid_sm,						
				{header:'营业收入排名',align:'right',width: 100,sortable: true,dataIndex:'yysr_rank',renderer:formatRank},
				...
				{header:"id",align:'right',width: 50,sortable: true,dataIndex:"ID",hidden:true,hideable: true},
