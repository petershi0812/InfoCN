Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'top10industrydb';  //industrydb
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("search_Industry_dataset",grid_sm));
	...
	var grid = new Ext.grid.GridPanel({	
	    ...
	    tbar: [	 
		{
	        ...
	        },	         	
            {
                ...
                iconCls: 'quickfilter',
                iconAlign: 'left',
                handler : fun_large_qucickfilter
            },
            {text: '',disabled : true},
            {text: '',disabled : true}]                        
        },	    
   ...
   ****************************/
	...
	var combinedchart_winpanel = new Ext.Window({ 
	   ...
	   /***************************
	     * ## 该页面所有基础函数
	     *   @@fun_large_qucickfilter:主界面快速筛选按钮
	     * 	 @@fun_combox_search: 主界面快速筛选确定按钮 --Depredated 
	   ...
	   ****************************/ 
	function fun_large_qucickfilter(){
   		var searchkeyword = Ext.getCmp('searchfiled').getValue();
   		var sql_str = '';
   		if(searchkeyword == ''){
   			Ext.Msg.alert('提示','请输入关键字!');
   		}
   		else{
   			sql_str = " zyywhd1 like '%"+searchkeyword+"%' or zyywhd2 like '%"+searchkeyword+"%' or zyywhd3 like '%"+searchkeyword+"%'";
   			sql_str = " ( " + sql_str + " ) and ";   			   		
	...
	function fun_show_primarycolumn(){
		var grid_col_model = Ext.getCmp("grid").getColumnModel();
	    var column_count = grid_col_model.getColumnCount();
	    for(var k = 21 ;k<=column_count-1;k++)
	    {
