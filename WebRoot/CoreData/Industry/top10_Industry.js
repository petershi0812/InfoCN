Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'top10industrydb|10';  //industrydb
	...
	var grid = new Ext.grid.GridPanel({	
        ...
        listeners:{
			...
			'rowdblclick' : function(grid,rowIndex,e) {
				...
				companydetailedinfo_Window.setSize(vs.width, vs.height);
				companyname = grid_store.getAt(rowIndex).get('dwmc1');
				yearid = grid_store.getAt(rowIndex).get('Year_id');
				companydetailedinfo_Window.show();	
				companydetailedinfo_Window.update('<iframe src=Industry/singlecompanypage/singlecompany.jsp?companyname='+encodeURI(encodeURI(companyname))+'&yearid='+ yearid + ' width="100%" height="100%" frameborder="no" scrolling="no"></iframe>');
				companydetailedinfo_Window.setTitle(companyname + '企业介绍');
			}
        }
	   	});
	 grid.render();	
...
'-',
   ...
   ***************************/	 	
	...
	********************************/
	 ...
	 * ## 企业单页详细信息
	********************************/	
	var companydetailedinfo_Window = new Ext.Window({
		id:'companydetailedinfo_Window',
        width : 600,       
        height: 440, 
        resizable:true,
        maximizable :false,
