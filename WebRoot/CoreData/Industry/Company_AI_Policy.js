Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'ppcompanypolicy';  //industrydb
   ...
   ****************************/	
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("ai_policy_dataset",sm));
   ...
   ***************************/	 	
	...
	function Create_pdfWindow(papertitle){
		...
		var pdf_winpanel = new Ext.Window({  
				...
				fill : true,
	      		layout : 'fit',
	      		items:[{html:'<iframe src=Industry/policy/policy.jsp?paperid=' +papertitle + ' width="100%" height="100%" frameborder="no" scrolling="yes"></iframe>'}]
		});		
	}
