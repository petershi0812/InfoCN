Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'nbsindustrialvaluecountry';
   ...
   ****************************/				    
    var province_store = new Ext.data.SimpleStore({
    	fields:['province_id'],
        proxy : new Ext.data.HttpProxy({ url : 'GetCountyCityComboxSelections?id=province&rights='+rightspk })
    });  
        
    var city_store = new Ext.data.SimpleStore({
    	fields:['city_id'],
    	proxy : new Ext.data.HttpProxy({ url : 'GetCountyCityComboxSelections?id=city&rights='+rightspk}),
   		baseParams:{province_id:''},
 		remoteSort:true        
    }); 
    var district_store = new Ext.data.SimpleStore({
    	fields:['district_id'],
    	proxy : new Ext.data.HttpProxy({ url : 'GetCountyCityComboxSelections?id=district&rights='+rightspk}),
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("NBS_县级市规模以上工业企业情况_Country",grid_sm));
	...
	var combinedchart_winpanel = new Ext.Window({ 
	   ...
	   ****************************/    
	   function fun_combox_search(){
	   		...
	   		var sql_str = '',sql_str_province = '',sql_str_city = '',sql_str_district = '';
	   		if(province_value == ''){
	   			...
	   			if(district_value != ''){
		   			...
		   			sql_str = sql_str_province+sql_str_city+sql_str_district;
