Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'nbsbasicinfocountry';
   ...
   ****************************/				    
    var province_store = new Ext.data.SimpleStore({
    	fields:['province_id'],
        proxy : new Ext.data.HttpProxy({ url : 'GetCountyComboxSelections?id=province&rights='+rightspk })
    });  
        
    var city_store = new Ext.data.SimpleStore({
    	fields:['city_id'],
    	proxy : new Ext.data.HttpProxy({ url : 'GetCountyComboxSelections?id=city&rights='+rightspk}),
   		baseParams:{province_id:''},
 		remoteSort:true        
    }); 
    var district_store = new Ext.data.SimpleStore({
    	fields:['district_id'],
    	proxy : new Ext.data.HttpProxy({ url : 'GetCountyComboxSelections?id=district&rights='+rightspk}),
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("NBS_县及县级市基本统计资料_Country",grid_sm));
