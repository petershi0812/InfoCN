Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'nbsincomeexpensecity';
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("NBS_各地区可支配收入和消费支出_City",grid_sm));
  ...
  function fun_combox_search(){
	...
	function fun_summary_submit(){
		...
		/*去掉[万]，[助理]*/
		combox_displayfield = replaceAll(combox_displayfield,"\\[万立方米]\\]","");
		combox_displayfield = replaceAll(combox_displayfield,"\\[人]\\]","");
