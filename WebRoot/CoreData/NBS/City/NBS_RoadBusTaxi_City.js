Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'nbsroadbustaxicity';
	var SelectionPoint = 0;
	var FieldStr_Point = 5;	
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("NBS_各地区道路面积及公共汽车、出租车拥有情况_City",grid_sm));
  ...
  function fun_combox_search(){
	...
	function fun_summary_submit(){
		...
		/*去掉[万]，[助理]*/
		combox_displayfield = replaceAll(combox_displayfield,"\\[万平方米]\\]","");
		combox_displayfield = replaceAll(combox_displayfield,"\\[万人次]\\]","");
		combox_displayfield = replaceAll(combox_displayfield,"\\[平方米]\\]","");
		combox_displayfield = replaceAll(combox_displayfield,"\\[辆]\\]","");
