Ext.onReady(function(){ 
   ...
   ****************************/				    
	...
	{ 
		var new_params={sql:grid_sql,dbname:database,numcolumnpoint:FieldStr_Point+10,rights:rightspk}; 
		Ext.apply(options.params,new_params); 
	});	
			
	var grid_sm = new Ext.grid.CheckboxSelectionModel();   		
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("MCCSC",grid_sm));
