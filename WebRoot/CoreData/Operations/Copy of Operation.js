Ext.onReady(function(){ 
   ...
   ****************************/				    
	...
	{ 
		var new_params={sql:grid_sql,dbname:database,numcolumnpoint:FieldStr_Point+1,rights:rightspk}; 
		Ext.apply(options.params,new_params); 
	});	
			
	var grid_sm = new Ext.grid.CheckboxSelectionModel();   		
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("住院手术量",grid_sm));
   ...
   ****************************/
   ...
   function fun_combox_search(){
   		...
   		var sql_str = '',sql_str_province = '',sql_str_city = '',sql_str_district = '',sql_str_grade='';
   		if(province_value == '' && hoplevel_value == '' ){
   			...
   			if(hoplevel_value != ''){
	   			...
	   			sql_str = sql_str_province+sql_str_city+sql_str_district  + sql_str_grade;
