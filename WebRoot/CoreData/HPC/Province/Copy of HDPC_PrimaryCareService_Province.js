Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'hdpcprimarycareserviceprovince';
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("HDPC_各地区基层医疗工作情况_Province",grid_sm));
  ...
  function fun_combox_search(){
	...
	function fun_summary_submit(){
		...
		/*去掉[万]，[助理]*/
		combox_displayfield = replaceAll(combox_displayfield,"\\[千\\]","");
