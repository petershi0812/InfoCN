Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'hdpcdiseasedeathchina';
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("HDPC_历年居民主要疾病死亡率_China",grid_sm));
   ...
   ****************************/
	...
	function fun_summary_submit(){
		...
		/*去掉[万]，[助理]*/
		combox_displayfield = replaceAll(combox_displayfield,"\\[十万分之一\\]","");
