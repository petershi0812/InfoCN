Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'hdpchospitaltreatmentschina';
	var SelectionPoint = 0;
	var FieldStr_Point = 2;	
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("HDPC_历年各类医院诊疗人次数_China",grid_sm));
