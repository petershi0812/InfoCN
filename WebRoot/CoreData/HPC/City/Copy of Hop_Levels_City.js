Ext.onReady(function(){ 
   ...
   ****************************/
	...
	var database = 'hpcmhhoplevelscity';
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("HPC_MH_HOPLevel_City",grid_sm));
  ...
  function fun_combox_search(){
   		...
   		var sql_str = '',sql_str_province = '',sql_str_city = '',sql_str_grade = '';
   		if(province_value == '' && hoplevel_value == ''){
   			...
   			if(hoplevel_value != ''){
				...
				sql_str_grade = sql_str_grade + " or ";
	   			...
	   			sql_str = sql_str_province+sql_str_city + sql_str_grade;
