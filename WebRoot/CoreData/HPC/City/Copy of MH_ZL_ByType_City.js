Ext.onReady(function(){ 
   ...
   ****************************/				    
    ...
    var grid_colModel= new Ext.grid.ColumnModel(fun_grid_colModel_config("HPC_MH_ZL_ByType_City",grid_sm));
  ...
  function fun_combox_search(){
   		...
   		var sql_str = '',sql_str_province = '',sql_str_city = '',sql_str_type = '';
   		if(province_value == '' && hoptype_value == ''){
   			...
   			if(hoptype_value != ''){
	   			...
	   			sql_str = sql_str_province+sql_str_city + sql_str_type;
