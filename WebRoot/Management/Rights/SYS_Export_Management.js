   ...
   ****************************/  
	...
	var sysgrid_colModel= new Ext.grid.ColumnModel(
		[
			...
			{header:"导出时间",align:'right',width: 130,sortable: true,dataIndex:"ExportDate"},
			{header:"导出模块",align:'right',width: 90,sortable: true,dataIndex:"ExportTreeName"},
			{header:"导出页面名称",align:'right',width: 110,sortable: true,dataIndex:"ExportPage"},
			{header:"导出按钮的归属",align:'right',width: 110,sortable: true,dataIndex:"ExportButton"},
			{header:"导出行数",align:'right',width: 100,sortable: true,dataIndex:"ExportRecords"}
		]);
